...
uniform mat4 model;
uniform mat4 camDifferentAnglendcMat;
uniform mat4 camDifferentAnglecamMat;
uniform int differentCamMatrix = 0;
...
void main()
{
	...
	if (differentCamMatrix == 1)
	{
		gl_Position = camDifferentAnglendcMat * camDifferentAnglecamMat * vec4(frag_pos, 1);
	}
	else if(differentCamMatrix == 0)
